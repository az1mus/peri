...
**Files:**
- Modify: `rust-create-agent/src/llm/types.rs:43-60`
...
Run: `cargo check -p rust-create-agent 2>&1 | head -40`
...
**Files:**
- Modify: `rust-create-agent/src/llm/anthropic.rs:557-559`（header 提取点）
- Modify: `rust-create-agent/src/llm/anthropic.rs:670-705`（TokenUsage + LlmResponse 构造点）
...
**Files:**
- Modify: `rust-create-agent/src/llm/openai.rs:590-614`（TokenUsage + LlmResponse 构造点）
...
**Files:**
- Modify: `rust-create-agent/src/agent/token.rs:5-18`（TokenTracker struct）
- Modify: `rust-create-agent/src/agent/token.rs:21-36`（accumulate 方法）
- Test: `rust-create-agent/src/agent/token.rs`（测试模块）
...
Run: `cargo test -p rust-create-agent --lib -- token`
Expected: 所有测试通过
...
**Files:**
- Modify: `rust-agent-tui/src/app/agent_ops.rs:152-171`
...
Run: `cargo check -p rust-agent-tui 2>&1 | head -40`
Expected: 编译通过
...
```bash
git add rust-create-agent/src/llm/types.rs rust-create-agent/src/llm/anthropic.rs rust-create-agent/src/llm/openai.rs rust-create-agent/src/agent/token.rs rust-agent-tui/src/app/agent_ops.rs
